...
We keep our privacy policy under regular review and we will place any updates on this web page. When such a change is made, we will post a notification of change and date of current version. You have a responsibility to view this policy from time to time to be aware of any such change. </p>
        </Row>
      </Container>
    );
};
